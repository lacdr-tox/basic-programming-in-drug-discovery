...
This is an opportune moment to explain boolean and conditional selection. The boolean class, in R called the logical class, is another class of data. It has the values `TRUE`, `FALSE` and `NA`  
